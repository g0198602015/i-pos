package fileUtility2.filePicker;
...
public class FilePickerActivity extends Activity implements AdapterView.OnItemClickListener {
    ...
    public static void setFileComparator(Comparator<File> fileComparator) {
        FilePickerActivity.fileComparator = fileComparator;
    }
    ...
    public static void setFileDisplayFilter(FileFilter fileDisplayFilter) {
        FilePickerActivity.fileDisplayFilter = fileDisplayFilter;
    }
    ...
    public static void setFileSelectFilter(FileFilter fileSelectFilter) {
        FilePickerActivity.fileSelectFilter = fileSelectFilter;
    }

    public static void setFileSelectMessage(String msg){
        FilePickerActivity.msg =msg;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.viewerClassName = bundle.getString("class");
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        switch (id) {
            ...
            case DIALOG_FILE_SELECT:
                builder.setMessage(FilePickerActivity.msg);
                builder.setPositiveButton("OK", null);
                return builder.create();
            default:
